...
#saveRDS(object = main_comparisons, file ="ResSummary_Paper/main_comparisons0.rds" )
...
```{r Table 1-6 and Figure 1}
library(xtable)
library(ggplot2)
main_comparisons = readRDS(file ="ResSummary_Paper/main_comparisons.rds" )
# msCCA300 = readRDS(file ="ResSummary_Paper/main_comparison_msCCA300V2.rds" )
# msCCA1000 = readRDS(file ="ResSummary_Paper/main_comparison_msCCA1000V2.rds" )
# main_comparisons = main_comparisons[!((main_comparisons$method%in%c("msCCAl1cv","msCCAl1pen"))),]
# main_comparisons = rbind(rbind(main_comparisons,msCCA300), msCCA1000)
# saveRDS(main_comparisons,file ="ResSummary_Paper/main_comparisons.rds" )
...
pdf(file = "RevisedFigure202409/computational_time_comparisons_rifle_msCCA.pdf", height = 3, width = 6)
pcomputation
dev.off()
```
